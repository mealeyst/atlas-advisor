...
import { CountryTable } from "../components/overview/components/CountryTable";
...
async function getCountries() {
  ...
  // World bank returns an array with the first item being metadata. We don't need the metadata.
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full px-4 py-8">
      <div className="w-full max-w-full">
        <CountryTable countries={countries} economicData={economicData} />
      </div>
    </div>
  );
}
